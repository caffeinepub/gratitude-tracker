...
import type { GratitudeEntry as _GratitudeEntry, Id as _Id, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addEntry(arg0: string, arg1: string | null): Promise<GratitudeEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.addEntry(arg0, to_candid_opt_n8(this._uploadFile, this._downloadFile, arg1));
                return from_candid_GratitudeEntry_n9(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async addGoal(arg0: string): Promise<Goal> {
        if (this.processError) {
            try {
    ...
    async deleteEntry(arg0: Id): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteGoal(arg0: Id): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getEntries(): Promise<Array<GratitudeEntry>> {
        if (this.processError) {
            try {
    ...
    async getSuggestedGoals(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSuggestedGoals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateGoal(arg0: Id, arg1: boolean): Promise<Goal> {
        if (this.processError) {
            try {
...
function from_candid_GratitudeEntry_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _GratitudeEntry): GratitudeEntry {
...
function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_GratitudeEntry>): Array<GratitudeEntry> {
    return value.map((x)=>from_candid_GratitudeEntry_n9(_uploadFile, _downloadFile, x));
}
